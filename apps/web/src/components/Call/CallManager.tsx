...
import { Phone, PhoneOff, Video, X, PhoneCall } from 'lucide-react';
...
export default function CallManager() {
  ...
  const isCaller   = activeCall && activeCall.initiatorId === user?.id;
  ...
  return (
    <>
      ...
      {/* Active Call Room (LiveKit) */}
      {isCallModalOpen && isActive && (
